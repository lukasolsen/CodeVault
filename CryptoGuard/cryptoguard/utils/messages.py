messages = {
    ...
    "file_decrypted": "[CryptoGuard] File decrypted successfully",
    "help": "[CryptoGuard] #### CryptoGuard Help ####",
    "version": "[CryptoGuard] Version: 1.0.0",
    "usage": "[CryptoGuard] Usage: cryptoguard [options] <file>",
    "options": "[CryptoGuard] Options:",
    "version_option": "[CryptoGuard]   -v, --version\t\t\tShow version number and exit",
    "encrypt_option": "[CryptoGuard]   -e, --encrypt\t\t\tEncrypt file",
    "decrypt_option": "[CryptoGuard]   -d, --decrypt\t\t\tDecrypt file",
    "key_option": "[CryptoGuard]   -k, --key\t\t\tThe key to use for encryption/decryption",
    "detect_option": "[CryptoGuard]   -det, --detect\t\tDetect encryption algorithm",
    "algorithm_option": "[CryptoGuard]   -algo, --algorithm\t\tChoose encryption algorithm",
    ...
    'error_loading_custom_method': "[CryptoGuard] Error loading custom method '{method}': {error}"
}
